...
return [
    ...
    */
    ...
    'in' => 'Вибране значення поля :attribute неприпустиме.',
    ...
    'find_the_wrong' => [
        'attempt_overlap' => 'Один і той самий елемент не може бути одночасно у списках знайдених і пропущених.',
        'attempt_count_mismatch' => 'Надіслані елементи мають повністю покривати всі елементи рівня (знайдені + пропущені = загальна кількість).',
    ],

    'arithmetic' => [
        'answers_coverage' => 'Надіслані відповіді мають покривати кожне рівняння рівня рівно один раз.',
        'unknown_equation' => 'Надіслані відповіді посилаються на рівняння, яке не належить цьому рівню.',
    ],
