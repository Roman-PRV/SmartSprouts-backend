...
return [
    ...
    'account_deletion' => [
        'code_not_applicable' => 'Ваш акаунт має пароль; підтвердіть видалення паролем, а не кодом.',
        'invalid_code' => 'Код видалення недійсний або протермінований.',
        'code_sent' => 'Код підтвердження надіслано на вашу пошту.',
    ],
    'consent' => [
        'not_current' => 'Прийміть чинні юридичні документи, щоб продовжити гру',
    ],
