...
class FindTheWrongItemAdminService
{
    ...
    /**
     * Delete the item and best-effort wipe its storage directory (TTS audio
     * dropped there by the observer in WIW-BE-07). Missing rows surface as
     * ModelNotFoundException for the controller to translate into 404.
     */
